...
LocalParameters::LocalParameters() :
        ...
        PARAM_CHAIN_LDDT_THRESHOLD(PARAM_CHAIN_LDDT_THRESHOLD_ID,"--chain-lddt-threshold", "per chain lddt threshold for filtercomplex", "accept alignments satisfying average lddt of all chains > thr [0.0,1.0]",typeid(float), (void *) &filtChainLddtThr, "^0(\\.[0-9]+)?|1(\\.0+)?$"),
...
//    tmalign.push_back(&PARAM_GAP_EXTEND);
    ...
    filtercomplex.push_back(&PARAM_CHAIN_LDDT_THRESHOLD);
